  ...
  return (
    <div className="flex flex-1 flex-col">
      ...
      <main className="mx-auto flex w-full max-w-220 flex-1 flex-col justify-center px-6 py-16">
        <p className="font-mono text-[12px] text-muted">N°404 &nbsp;·&nbsp; entry not found</p>
        <h1 className="mt-3.5 font-display text-[40px] leading-[1.02] font-bold tracking-[-0.03em] text-body md:text-[64px]">
          This page isn&rsquo;t in the log.
        </h1>
        <p className="mt-5 font-serif text-[17px] leading-[1.6] text-muted">
